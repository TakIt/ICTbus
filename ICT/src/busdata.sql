...
CREATE TABLE 復路時刻表(ID int,HONBUTOU time,KENKYUTOU time,MINAMICHITOSE time,CHITOSE time)AS SELECT * FROM CSVREAD('C:\Users\小橋司明\ICTデータ\復路時刻表.csv',null,'UTF-8',',');
